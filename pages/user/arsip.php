...
// Buat query berdasarkan kategori
...
// Year statistics - Dinamis untuk 3 tahun terakhir berdasarkan field tanggal
...
<section class="section-arsip">
    <div class="container">
                ...
                <table class="table table-hover mb-0">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th style="width: 180px;" class="text-center">Penulis</th>
        ...
        word-wrap: break-word;">
                                        <?php
                                        $penulis = $arsip['penulis'] ?? 'Admin Lab NCS';
                ...
                <div class="d-flex justify-content-center align-items-center mt-4">
                    <nav>
                        <ul class="pagination mb-0">
                            ...
                            // Sesuaikan jika di awal
                            if ($page_num <= 3) {
                                $end_page = min(5, $total_pages);
                            }

                            // Sesuaikan jika diakhir
